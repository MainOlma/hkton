...
function drawMap(countryData) {
  ...
  var labels = svg.selectAll("text.label").data(countryData).enter().append("text").attr("class", "label").attr("font-size", 16).attr("text-anchor", "middle").attr("fill", "black").attr("x", function (d) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "29705" + '/');
...
//# sourceMappingURL=/hkton.e31bb0bc.js.map